...
--- we have 7 types of prmitifs for javaScript 1- string example let nom ="Mohamed" 
2-number example :let age = 20 
3-BigInt example :let grandNumber =12345678n; 
4-boolean example :let major = true;
5-Undefined example :let x; we don't know its valuer 
6-Null example : let y = null; here we have no variable 
7-Symbol example let id = Symbol("id"); singel code 
